...
Test Setup
    ...
    ${TEST_140_SETUP_VALUE} =    Get Variable Value    ${TEST_140_SETUP}
    IF    $TEST_SETUP_VALUE is not None        Run Keyword    ${TEST_SETUP}
    IF    $TEST_140_SETUP_VALUE is not None    Run Keyword    ${TEST_140_SETUP}
...
Test Teardown
    ...
    ${TEST_140_TEARDOWN_VALUE} =    Get Variable Value    ${TEST_140_TEARDOWN}
    ${TEST_TEARDOWN_VALUE} =        Get Variable Value    ${TEST_TEARDOWN}
    IF    $TEST_140_TEARDOWN_VALUE is not None    Run Keyword    ${TEST_140_TEARDOWN}
