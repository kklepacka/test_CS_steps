...
Test Setup
    ...
    IF    $TEST_303_SETUP_VALUE is not None    Run Keyword    ${TEST_303_SETUP}
...
Test Teardown
    ...
    IF    $TEST_303_TEARDOWN_VALUE is not None    Run Keyword    ${TEST_303_TEARDOWN}
