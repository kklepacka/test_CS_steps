...
Test Setup
    ...
    ${TEST_135_SETUP_VALUE} =    Get Variable Value    ${TEST_135_SETUP}
    IF    $TEST_SETUP_VALUE is not None        Run Keyword    ${TEST_SETUP}
    IF    $TEST_135_SETUP_VALUE is not None    Run Keyword    ${TEST_135_SETUP}
...
Test Teardown
    ...
    ${TEST_135_TEARDOWN_VALUE} =    Get Variable Value    ${TEST_135_TEARDOWN}
    ${TEST_TEARDOWN_VALUE} =        Get Variable Value    ${TEST_TEARDOWN}
    IF    $TEST_135_TEARDOWN_VALUE is not None    Run Keyword    ${TEST_135_TEARDOWN}
