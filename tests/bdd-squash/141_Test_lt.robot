...
Test Setup
    ...
    ${TEST_141_SETUP_VALUE} =    Get Variable Value    ${TEST_141_SETUP}
    IF    $TEST_SETUP_VALUE is not None        Run Keyword    ${TEST_SETUP}
    IF    $TEST_141_SETUP_VALUE is not None    Run Keyword    ${TEST_141_SETUP}
...
Test Teardown
    ...
    ${TEST_141_TEARDOWN_VALUE} =    Get Variable Value    ${TEST_141_TEARDOWN}
    ${TEST_TEARDOWN_VALUE} =        Get Variable Value    ${TEST_TEARDOWN}
    IF    $TEST_141_TEARDOWN_VALUE is not None    Run Keyword    ${TEST_141_TEARDOWN}
